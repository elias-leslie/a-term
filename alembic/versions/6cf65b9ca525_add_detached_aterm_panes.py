...
def upgrade() -> None:
    ...
    op.create_index(
        "idx_aterm_panes_detached_order",
        "aterm_panes",
...
def downgrade() -> None:
    """Downgrade schema."""
    op.drop_index("idx_aterm_panes_detached_order", table_name="aterm_panes")
    op.drop_column("aterm_panes", "is_detached")
