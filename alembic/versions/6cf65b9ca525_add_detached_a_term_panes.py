...
def upgrade() -> None:
    ...
    op.create_index(
        "idx_a_term_panes_detached_order",
        "a_term_panes",
...
def downgrade() -> None:
    """Downgrade schema."""
    op.drop_index("idx_a_term_panes_detached_order", table_name="a_term_panes")
    op.drop_column("a_term_panes", "is_detached")
