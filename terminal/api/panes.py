...
@router.get("/api/terminal/panes/detached", response_model=PaneListResponse)
...
@router.post("/api/terminal/panes/{pane_id}/detach", response_model=PaneResponse)
...
@router.post("/api/terminal/panes/{pane_id}/attach", response_model=PaneResponse)
