...
``terminal.utils.tmux`` exactly as before the package split.
"""

from __future__ import annotations

# Re-export subprocess and uuid so tests can patch terminal.utils.tmux.subprocess
# and terminal.utils.tmux._uuid_mod without changes.
