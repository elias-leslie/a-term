...
# ---------------------------------------------------------------------------
# Port allocation — single source of truth for Terminal.
# ---------------------------------------------------------------------------
...
class Settings(BaseSettings):
    ...
    # Terminal service
    terminal_port: int = TERMINAL_BACKEND_PORT

    # CORS
    cors_origins: list[str] = [
        f"http://localhost:{TERMINAL_FRONTEND_PORT}",
    ]
    ...
    recording_dir: Path = Path.home() / ".cache" / "summitflow-terminal" / "recordings"
