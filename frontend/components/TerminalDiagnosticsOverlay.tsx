...
import type {
  DiagnosticEntry,
  DiagnosticCounters,
} from '@/lib/hooks/use-terminal-diagnostics'
...
interface TerminalDiagnosticsOverlayProps {
  enabled: boolean
  themeId: string
  sessionMode?: string
...
export function TerminalDiagnosticsOverlay({
  enabled,
  themeId,
  sessionMode,
  getDiagnostics,
}: TerminalDiagnosticsOverlayProps) {
