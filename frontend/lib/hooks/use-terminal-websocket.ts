...
export function useTerminalWebSocket({
  ...
  }, [onStatusChange, onDisconnect, onMessage, onTerminalMessage, onScrollbackSync, onScrollbackDelta, onViewportInit, onScrollbackPage, onBeforeReconnectData, getDimensions])
