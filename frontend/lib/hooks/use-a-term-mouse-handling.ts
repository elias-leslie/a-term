...
/**
 * Sets up mouse event handling for a a-term to enable local text selection
 ...
 *
 * @param aTerm - The xterm instance
 * @param container - The DOM element containing the aTerm
 * @returns Cleanup function to remove event listeners
 */
export function setupATermMouseHandling(
  aTerm: XtermATerm,
  ...
  const forceLocalMouseHandling = (e: MouseEvent) => {
    ...
    const core = (aTerm as unknown as XtermCoreInternal)._core
