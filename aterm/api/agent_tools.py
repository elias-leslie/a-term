...
@router.get("/api/aterm/agent-tools", response_model=list[AgentToolResponse])
...
@router.post("/api/aterm/agent-tools", response_model=AgentToolResponse, status_code=201)
...
@router.patch("/api/aterm/agent-tools/{tool_id}", response_model=AgentToolResponse)
...
@router.delete("/api/aterm/agent-tools/{tool_id}")
