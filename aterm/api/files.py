...
Stores uploaded files server-side; returns path for use in aterm commands.
"""
...
@router.post("/api/aterm/files", response_model=FileUploadResponse)
@limiter.limit("10/minute")
async def upload_file(request: Request, file: UploadFile) -> FileUploadResponse:
    """Upload a file for use in aterm commands.
